...
@section('content')
    ...
    <button onclick="kirimPresensi()"
        id="btnPresensi"
        class="w-full sm:w-auto bg-[#0B1F4D] hover:bg-blue-900 active:scale-95 transition 
               text-white font-semibold px-6 py-3 rounded-xl shadow-lg flex items-center 
               justify-center gap-2 mx-auto">

        <span></span>
        <span id="btnText">Kirim Presensi</span>
